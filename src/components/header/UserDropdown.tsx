  ...
  return (
    <div className='relative'>
      <button onClick={toggleDropdown} className='flex items-center text-gray-700 dropdown-toggle dark:text-gray-400'>
        <span className='mr-3 h-10 w-10 overflow-hidden rounded-full aspect-square border border-gray-200'>
        ...
        <ul className='flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800'>
          <li>
            <DropdownItem
              ...
              tag='a'
              onClick={() => navigate(`${AppPath.PROFILE}/${profile?.userId}`)}
