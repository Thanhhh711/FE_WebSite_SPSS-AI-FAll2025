          ...
          <div>
            ...
            <div className='grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32'>
              <div>
                ...
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>{defaultAddress?.countryName}</p>
              </div>

              <div>
                <p className='mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400'>City/State</p>
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>{defaultAddress?.city}</p>
              </div>

              <div>
                <p className='mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400'>Postal Code</p>
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>{defaultAddress?.postCode}</p>
              </div>
              ...
              <div>
                ...
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>
                  {defaultAddress
                    ? `${defaultAddress.streetNumber ?? ''} ${defaultAddress.addressLine1 ?? ''}, ${defaultAddress.addressLine2 ?? ''}, ${defaultAddress.ward ?? ''}, ${defaultAddress.city ?? ''}, ${defaultAddress.province ?? ''}, ${defaultAddress.postCode ?? ''}`
                    : 'No default address'}
                </p>
              </div>
            </div>
