...
import { Variation, VariationOption, VarionOptionInResponse } from '../../types/variation.type'
...
export default function ProductModal({ isOpen, onClose, product, onSave, isViewMode }: ProductModalProps) {
  ...
  const mapDetailToForm = (detail: Product): ProductFormState => ({
    ...
    skinConditionIds: detail.skinConditionIds || [],
    skinTypeIds: detail.skinTypeIds || [],
    variationOptionIds: detail.variationOptionIds || [],
